      ...
      <main className="flex-1">
        <div className="container max-w-screen-md mx-auto space-y-8 px-4 py-10 md:px-6">
          <div className="space-y-2">
            <h1 className="font-headline text-3xl font-extrabold tracking-tight text-white">About Cine-Spot</h1>
          ...
          <section className="space-y-4">
            <h2 className="text-lg font-semibold text-white">Why Cine-Spot?</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-white">Feedback & Support</h2>
